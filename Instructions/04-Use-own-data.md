---
lab:
  title: 独自のデータを使用する生成 AI アプリを作成する (非推奨)
...
# 独自のデータを使用する生成 AI アプリを作成する (非推奨)

> **注**: この演習は非推奨です。 代わりの演習 (<https://microsoftlearning.github.io/mslearn-ai-studio/Instructions/Exercises/04a-use-own-data.html>) を行うことを検討してください。
