...
1. Azure AI Studio の **[ホーム]** ページで、**[+ 新しいプロジェクト]** を選択します。
1. **プロジェクトの作成**ウィザードで、プロジェクトの一意の名前を指定し、**[カスタマイズ]** を選択して、次の設定でプロジェクトを作成します。

    - **ハブの作成**: *次の設定で新しいリソースを作成します。*
...
1. [セットアップ] ウィンドウで、**[データの追加]** タブを選択し、**brochures-index** プロジェクト インデックスを追加して、**[ハイブリッド (ベクトル + キーワード)]** 検索タイプを選択します。
