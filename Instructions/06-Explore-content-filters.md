---
lab:
  title: コンテンツ フィルターを適用して有害なコンテンツの出力を防ぐ (非推奨)
...
# コンテンツ フィルターを適用して有害なコンテンツの出力を防ぐ (非推奨)

> **注**: この演習は非推奨です。 代わりの演習 (<https://go.microsoft.com/fwlink/?linkid=2353440>) を行うことを検討してください。
