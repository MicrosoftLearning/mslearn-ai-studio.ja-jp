...
1. Azure AI Foundry プロジェクト ページの右上にあるツール バーで、**プレビュー機能**アイコンを使用してプレビュー機能を表示します。
1. **[Azure AI モデル推論サービスにモデルをデプロイする]** 機能を有効にします。 次に、**プレビュー機能**ウィンドウを閉じます。
...
1. デプロイの **[プロビジョニングの状態]** が **[成功]** になるまで待ちます。
...
1. 次の設定で **Phi-3.5-mini-instruct** モデルをデプロイします。
    - **デプロイ名**: *モデル デプロイの一意の名前 - たとえば、`phi-35-model`*
    - **デプロイの種類**: グローバル標準
    - **デプロイの詳細**: *既定の設定を使用します*
