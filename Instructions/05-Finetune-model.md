---
lab:
  title: Azure AI Foundry でのチャット入力候補用に言語モデルを微調整する
---

# Azure AI Foundry でのチャット入力候補用に言語モデルを微調整する
...
1. 新しい微調整モデルを追加するボタンを選択し、`gpt-35-turbo` モデルを選択して、**[次へ]** を選択してから、**[確認]** を選択します。
...
1. デプロイした `gpt-35-model` 基本モデルがセットアップ ウィンドウで選択されていることを確認します。
