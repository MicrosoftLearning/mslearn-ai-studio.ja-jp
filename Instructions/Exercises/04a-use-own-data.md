...
1. モデルのプレイグラウンドの左側のペインで、**[gpt-5.2]** モデルが選択されていることを確認します。
...
1. **[エクスプローラー]** ペインの **/labfiles/tools/python/tools-app** フォルダーで、**.env** ファイルを選択して開きます。 次に、構成値を更新して、**Azure OpenAI エンドポイント**と **gpt-5.2** モデルのデプロイに割り当てられた名前を含めます。
